...
static NSDictionary<NSString *, NSString *> *WAGRAliasToGateTarget(void) {
    ...
    dispatch_once(&once, ^{
        map = @{
            ...
            @"wagr_metab_master_enabled": @"metab_master_enabled",
            @"watweak_bundle_internal_master": @"internal_master",
            @"watweak_bundle_aura_simulation": @"aura_simulation",
            @"wa_sideload_keychain_rewrite_enabled": @"keychain_rewrite_enabled",
            @"wa_keychain_observer_enabled": @"keychain_observer_enabled",
            @"wa_employee_master": @"employee_master",
            @"wa_abprops_observer_enabled": @"abprops_observer_enabled",
            @"wa_liquid_glass_enabled": @"liquid_glass_enabled",
            @"wa_liquid_glass_userdefaults_overrides": @"liquid_glass_userdefaults_overrides",
            @"wa_liquid_glass_method_hooks": @"liquid_glass_method_hooks",
...
static BOOL WAGRGateStoreShouldRemoveOverrideKey(NSString *key) {
    ...
    if ([key hasPrefix:@"wagr.dogfood.gate."] || [key hasPrefix:@"wa_lg_ios_liquid_glass_"] || [key hasPrefix:@"watweak_bundle_"]) return YES;
    if ([key isEqualToString:@"wagr_native_debug_menu_enabled"] || [key isEqualToString:@"wagr_internal_master_enabled"] || [key isEqualToString:@"wagr_metab_master_enabled"] ||
        [key isEqualToString:@"wa_sideload_keychain_rewrite_enabled"] || [key isEqualToString:@"wa_keychain_observer_enabled"] ||
        [key isEqualToString:@"wa_employee_master"] || [key isEqualToString:@"wa_abprops_observer_enabled"] ||
        [key isEqualToString:@"wa_liquid_glass_enabled"] || [key isEqualToString:@"wa_liquid_glass_userdefaults_overrides"] ||
        [key isEqualToString:@"wa_liquid_glass_method_hooks"]) return YES;
    ...
    for (NSString *key in all) {
        ...
        BOOL isLegacyAlias = ![canonical isEqualToString:key] &&
            ([key hasPrefix:@"wagr.dogfood.gate."] ||
             ...
             [key hasPrefix:@"watweak_bundle_"] ||
             [key isEqualToString:@"wagr_native_debug_menu_enabled"] ||
             [key isEqualToString:@"wagr_internal_master_enabled"] || [key isEqualToString:@"wagr_metab_master_enabled"] ||
             [key isEqualToString:@"wa_sideload_keychain_rewrite_enabled"] ||
             [key isEqualToString:@"wa_keychain_observer_enabled"] ||
             [key isEqualToString:@"wa_employee_master"] ||
             [key isEqualToString:@"wa_abprops_observer_enabled"] ||
             [key isEqualToString:@"wa_liquid_glass_enabled"] ||
             [key isEqualToString:@"wa_liquid_glass_userdefaults_overrides"] ||
             [key isEqualToString:@"wa_liquid_glass_method_hooks"]);
